  ...
  <?php include 'rf-admin/controller/database.php'; ?>
  <?php
  $artikel_id = $mysqli->real_escape_string($_GET['artikel_id']);
  $q_news  = $mysqli->query("SELECT * FROM berita WHERE artikel_id = '$artikel_id'");
        ...
        <div class="left_content">
          ...
          <div class="single_page">
            ...
            <div class="col-lg-12">
              ...
              <?php
              $q_komentar = $mysqli->query("SELECT * FROM komentar WHERE artikel_id = '$artikel_id' ORDER BY tanggal DESC");
